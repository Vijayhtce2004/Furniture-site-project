...
function ContactForm() {
  ...
  let [formData2, setFromData2] = useState({ lastName: "vijay" })
  let [formData3, setFromData3] = useState({ email: "vijay@gmail.com" })
  let [formData4, setFromData4] = useState({ message: "vijay hello" })
